...
private slots:
    ...
    void on_BuyDRACO_clicked();
    void on_SellDRACOBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputDRACO_textChanged(const QString &arg1);
    ...
    QString BuyDRACO(QString OrderType, double Quantity, double Rate);
    QString SellDRACO(QString OrderType, double Quantity, double Rate);

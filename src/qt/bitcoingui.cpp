...
BitcoinGUI::BitcoinGUI(QWidget *parent):
    ...
    nWeight(0)
{   
    setFixedSize(900, 575);
	QFontDatabase::addApplicationFont(":/fonts/Bebas");
    setWindowTitle(tr("Draco") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/draco"));
    setWindowIcon(QIcon(":icons/draco"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&Account"), this);
...
//#endif
    ...
    //ccexAction = new QAction(QIcon(":/icons/ccex"), tr("&Ccex"), this);
    //ccexAction->setToolTip(tr("Hip Hop"));
    //ccexAction->setCheckable(true);
    //ccexAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    //tabGroup->addAction(ccexAction);
    
    //bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk"), this);
    ...
    //poloniexAction = new QAction(QIcon(":/icons/poloniex"), tr("&Poloniex"), this);
    //poloniexAction->setToolTip(tr("Poloniex"));
    //poloniexAction->setCheckable(true);
    //poloniexAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    //tabGroup->addAction(poloniexAction);

    //yobitAction = new QAction(QIcon(":/icons/yobit"), tr("&Yobit"), this);
    ...
    //btceAction = new QAction(QIcon(":/icons/btce"), tr("&Btc-E"), this);
    //btceAction->setToolTip(tr("Yobit"));
    //btceAction->setCheckable(true);
    //btceAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    //tabGroup->addAction(btceAction);
    
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send Draco"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a Draco address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive Draco"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(receiveCoinsAction);

    historyAction = new QAction(QIcon(":/icons/history"), tr("&Draco Acc Statements"), this);
...
//#endif
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Draco"), this);
    aboutAction->setToolTip(tr("Show information about Draco"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo-64"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Draco"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    //trade->addSeparator();
    //trade->addAction(poloniexAction);
    //trade->addSeparator();
    //trade->addAction(yobitAction);
    //trade->addSeparator();
    //trade->addAction(ccexAction);
    //trade->addSeparator();
    //trade->addAction(btceAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Draco client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Draco client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Draco network", "", count));
}
...
//void BitcoinGUI::gotoPoloniexPage()
//{
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Draco address or malformed URI parameters."));
    }
